...
public class Gstoverseas {
	...
	private String	tran_and_parttran;
	...
	public String getTran_and_parttran() {
		return tran_and_parttran;
	}
	public void setTran_and_parttran(String tran_and_parttran) {
		this.tran_and_parttran = tran_and_parttran;
	}
	...
	public String toString() {
		return "Gstoverseas [tran_date=" + tran_date + ", tran_id=" + tran_id + ", accountd=" + accountd
				+ ", tran_and_parttran=" + tran_and_parttran + ", returnmonth=" + returnmonth + ", part_tran_id="
				+ part_tran_id + ", part_tran_type=" + part_tran_type + ", tran_crncy=" + tran_crncy + ", inv_no="
				+ inv_no + ", inv_date=" + inv_date + ", inv_amt_fcy=" + inv_amt_fcy + ", rate=" + rate
				+ ", inv_amt_inr=" + inv_amt_inr + ", client=" + client + ", description=" + description + ", employee="
				+ employee + ", start_date=" + start_date + ", end_date=" + end_date + ", payment_date=" + payment_date
				...
				+ verify_time + ", modify_flg=" + modify_flg + ", uniqueid=" + uniqueid + ", getTran_date()="
				+ getTran_date() + ", getTran_id()=" + getTran_id() + ", getAccountd()=" + getAccountd()
				+ ", getTran_and_parttran()=" + getTran_and_parttran() + ", getReturnmonth()=" + getReturnmonth()
				+ ", getPart_tran_id()=" + getPart_tran_id() + ", getPart_tran_type()=" + getPart_tran_type()
				+ ", getTran_crncy()=" + getTran_crncy() + ", getInv_no()=" + getInv_no() + ", getInv_date()="
				+ getInv_date() + ", getInv_amt_fcy()=" + getInv_amt_fcy() + ", getRate()=" + getRate()
				+ ", getInv_amt_inr()=" + getInv_amt_inr() + ", getClient()=" + getClient() + ", getDescription()="
				+ getDescription() + ", getEmployee()=" + getEmployee() + ", getStart_date()=" + getStart_date()
				+ ", getEnd_date()=" + getEnd_date() + ", getPayment_date()=" + getPayment_date()
				+ ", getRemit_amt_inr()=" + getRemit_amt_inr() + ", getBank_account()=" + getBank_account()
				+ ", getInvoice_no()=" + getInvoice_no() + ", getRemit_amt_fcy()=" + getRemit_amt_fcy()
				+ ", getRemit_rate()=" + getRemit_rate() + ", getFbank_chg_fcy()=" + getFbank_chg_fcy()
				+ ", getEx_fluc()=" + getEx_fluc() + ", getBank_charges()=" + getBank_charges() + ", getDel_flg()="
				+ getDel_flg() + ", getEntity_flg()=" + getEntity_flg() + ", getEntry_user()=" + getEntry_user()
				+ ", getEntry_time()=" + getEntry_time() + ", getModify_user()=" + getModify_user()
				+ ", getModify_time()=" + getModify_time() + ", getVerify_user()=" + getVerify_user()
				+ ", getVerify_time()=" + getVerify_time() + ", getModify_flg()=" + getModify_flg() + ", getUniqueid()="
				+ getUniqueid() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
	public Gstoverseas(Date tran_date, String tran_id, String accountd, String tran_and_parttran, String returnmonth,
			BigDecimal part_tran_id, String part_tran_type, String tran_crncy, String inv_no, Date inv_date,
			BigDecimal inv_amt_fcy, BigDecimal rate, BigDecimal inv_amt_inr, String client, String description,
			String employee, Date start_date, Date end_date, Date payment_date, BigDecimal remit_amt_inr,
			String bank_account, String invoice_no, BigDecimal remit_amt_fcy, BigDecimal remit_rate,
			BigDecimal fbank_chg_fcy, BigDecimal ex_fluc, BigDecimal bank_charges, String del_flg, String entity_flg,
			String entry_user, Date entry_time, String modify_user, Date modify_time, String verify_user,
			Date verify_time, String modify_flg, String uniqueid) {
		super();
		this.tran_date = tran_date;
		this.tran_id = tran_id;
		this.accountd = accountd;
