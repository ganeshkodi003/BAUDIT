...
public class BTMAdminAssociateProfile {
	...
	public BTMAdminAssociateProfile(String ifsc, String bank, String bank_act_no) {
		super();
		this.ifsc = ifsc;
		this.bank = bank;
		this.bank_act_no = bank_act_no;
	...
	public BTMAdminAssociateProfile(String resource_id, String organisation, String category, String resource_name,
			...
			String entity_flg, String modify_flg, String session_id, String imei, Date dor, String ifsc, String bank,
			String bank_act_no, byte[] emp_photo) {
		super();
	...
	public BTMAdminAssociateProfile(String organisation, String category, String resource_id, String resource_name,
			...
			String channel_id, String locked_flg, String session_id, String imei, Date dor) {
		super();
		this.organisation = organisation;
		this.category = category;
		this.resource_id = resource_id;
	...
	public BTMAdminAssociateProfile(BTMAdminAssociateMod ver) {
		this.organisation = ver.getOrganisation();
		this.category = ver.getCategory();
		this.resource_id = ver.getResource_id();
		this.resource_name = ver.getResource_name();
		this.employee_ref = ver.getEmployee_ref();
		this.employee_id = ver.getEmployee_id();
		this.doj = ver.getDoj();
		this.dob = ver.getDob();
		this.groups = ver.getGroups();
		this.team = ver.getTeam();
		this.report_mgr_id = ver.getReport_mgr_id();
		this.report_mgr_name = ver.getReport_mgr_name();
		this.design = ver.getDesign();
		this.role = ver.getRole();
		this.qual = ver.getQual();
		this.addl_qual = ver.getAddl_qual();
		this.skill_set = ver.getSkill_set();
		this.expertise = ver.getExpertise();
		this.pancard = ver.getPancard();
		this.aadhar = ver.getAadhar();
		this.passport = ver.getPassport();
		this.driving_license = ver.getDriving_license();
		this.gender = ver.getGender();
		this.blood_group = ver.getBlood_group();
		this.marital_status = ver.getMarital_status();
		this.dependants = ver.getDependants();
		this.mobile = ver.getMobile();
		this.alt_mobile = ver.getAlt_mobile();
		this.access_id = ver.getAccess_id();
		this.email = ver.getEmail();
		this.addr1 = ver.getAddr1();
		this.addr2 = ver.getAddr2();
		this.city = ver.getCity();
		this.state = ver.getState();
		this.country = ver.getCountry();
		this.postal_code = ver.getPostal_code();
		this.loc_addr1 = ver.getLoc_addr1();
		this.loc_addr2 = ver.getLoc_addr2();
		this.loc_city = ver.getLoc_city();
		this.loc_state = ver.getLoc_state();
		this.loc_country = ver.getLoc_country();
		this.loc_postal_code = ver.getLoc_postal_code();
		this.user_cont_person = ver.getUser_cont_person();
		this.cont_person_no = ver.getCont_person_no();
		this.password = ver.getPassword();
		this.life_of_pw = ver.getLife_of_pw();
		this.acct_expy_date = ver.getAcct_expy_date();
		this.pw_expy_date = ver.getPw_expy_date();
		this.user_remarks = ver.getUser_remarks();
		this.disable_flg = ver.getDisable_flg();
		this.dis_start_date = ver.getDis_start_date();
		this.dis_end_date = ver.getDis_end_date();
		this.login_low = ver.getLogin_low();
		this.login_high = ver.getLogin_high();
		this.entry_user = ver.getEntry_user();
		this.modify_user = ver.getModify_user();
		this.verify_user = ver.getVerify_user();
		this.entry_time = ver.getEntry_time();
		this.modify_time = ver.getModify_time();
		this.verify_time = ver.getVerify_time();
		this.del_flg = ver.getDel_flg();
		this.entity_flg = ver.getEntity_flg();
		this.modify_flg = ver.getModify_flg();
		this.first_name = ver.getFirst_name();
		this.middle_name = ver.getMiddle_name();
		this.last_name = ver.getLast_name();
		this.short_name = ver.getShort_name();
		this.virtual_flg = ver.getVirtual_flg();
		this.login_status = ver.getLogin_status();
		this.channel_id = ver.getChannel_id();
		this.locked_flg = ver.getLocked_flg();
		}
	
	
	
	public BTMAdminAssociateProfile() {
		super();
