...
@Entity
@Table(name = "BTM_PLACEMENT_MASTER")
public class PlacementMaintenance {
...
//	private String bank_name;
	...
	private String remitence_reference;
	...
	public String getRemitence_reference() {
		return remitence_reference;
	}
	public void setRemitence_reference(String remitence_reference) {
		this.remitence_reference = remitence_reference;
	}
	...
	public String setGrn_amt(String grn_amt) {
		return this.grn_amt = grn_amt;
	}
	...
	public void setDp_date(String Date) {
	...
	public PlacementMaintenance() {
		super();
		// TODO Auto-generated constructor stub
	}
	public PlacementMaintenance(String vendor, String location, String po_no, Date po_date, String extn_flg,
			...
			String srl_no, Character flag, String message, Date auth_time, String upload_date, String po_id, String cin,
			String pan, String gstin_1, String vendor1, String hsn, String acct_type, String acct_no, String acct_name,
			String ifsc_code, String swift_code, String remitence_reference) {
		super();
		this.vendor = vendor;
		this.location = location;
		this.po_no = po_no;
