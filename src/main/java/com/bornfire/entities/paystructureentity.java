...
@Entity
@Table(name = "BTM_SAL_PAY")
@IdClass(BAJ_Sal_Pay_Embedded_Id.class)
public class paystructureentity {
	...
	public paystructureentity(String emp_no, String emp_name, String emp_desig, String emp_group, String emp_division,
	...
	public String toString() {
		return "paystructureentity [emp_no=" + emp_no + ", emp_name=" + emp_name + ", emp_desig=" + emp_desig
				...
				+ ifsc_code + ", remarks=" + remarks + ", aadhar_no=" + aadhar_no + "]";
	}
