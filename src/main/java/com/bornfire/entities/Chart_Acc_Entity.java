...
@Entity
@Table(name = "BTM_CHART_OF_ACCOUNTS")
public class Chart_Acc_Entity {
	...
	public Chart_Acc_Entity(String classification, String acct_type, String gl_code, String gl_desc, String glsh_code,
			String glsh_desc, String acct_num, String acct_name, String add_det_flg, String acct_partition,
			String acct_crncy, String ref_crncy, String ref_code, String ref_desc, String rpt_code, String acct_status,
			BigDecimal cr_amt, BigDecimal dr_amt, BigDecimal acct_bal, BigDecimal ref_crncy_bal, String entry_user,
			Date entry_time, String modify_user, Date modify_time, String auth_user, Date auth_time, String entity_flg,
			String del_flg, String acct_cls_flg, Date acct_cls_date, String own_type, String own_remarks,
			String vendor_type, String vendor_name, String pan_no, String gstin, String passport, String bank_acc_name,
			String bank_remarks) {
		super();
		this.classification = classification;
		this.acct_type = acct_type;
