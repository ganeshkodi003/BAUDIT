...
public class BTMAdminHolidayMaster {
	...
	/*
	 * public String getDay() { return day; } public void setDay(String day) {
	 * this.day = day; }
	 */
	public BTMAdminHolidayMaster(BigDecimal record_srl, String orgn, String location, String cal_year, String cal_month,
			...
			String entity_flg, String modify_flg, String record_status, String day) {
		super();
		this.record_srl = record_srl;
		this.orgn = orgn;
		this.location = location;
