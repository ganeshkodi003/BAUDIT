...
@Entity
@Table(name="GST_VIEW")
@IdClass(BTM_GST_VIEW_EMBEDEN.class)
...
public class gst {
	...
	public gst(String fin_year, Date tran_date, String tran_id, String part_tran_id, String part_tran_type,
			String client, String gstin, String invoice_no, Date invoice_date, String inv_desc, BigDecimal inv_amt,
			BigDecimal eligible_amt, BigDecimal inv_cgst, BigDecimal inv_sgst, BigDecimal inv_igst,
			...
			String client_remark, String gst_type) {
		super();
		this.fin_year = fin_year;
		this.tran_date = tran_date;
		this.tran_id = tran_id;
