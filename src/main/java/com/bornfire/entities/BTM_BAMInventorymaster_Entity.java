...
@Entity
@Table(name="BTM_BAMINVENTORY_MASTER")
public class BTM_BAMInventorymaster_Entity {
	@Id
	...
	public String toString() {
		return "BTM_BAMInventorymaster_Entity [asst_srl_no=" + asst_srl_no + ", asst_name=" + asst_name
				+ ", acc_number=" + acc_number + ", asset_head=" + asset_head + ", asset_category=" + asset_category
				...
				+ verify_flg + ", getAsst_srl_no()=" + getAsst_srl_no() + ", getAsst_name()=" + getAsst_name()
				+ ", getAcc_number()=" + getAcc_number() + ", getAsset_head()=" + getAsset_head()
				+ ", getAsset_category()=" + getAsset_category() + ", getAsset_sub_category()="
				+ getAsset_sub_category() + ", getCategory_desc()=" + getCategory_desc() + ", getAsset_type()="
				+ getAsset_type() + ", getAsst_crncy()=" + getAsst_crncy() + ", getDate_of_purchase()="
				+ getDate_of_purchase() + ", getYear_of_purchase()=" + getYear_of_purchase() + ", getOrg_cost()="
				+ getOrg_cost() + ", getLife_span_mth()=" + getLife_span_mth() + ", getAsst_exp_date()="
				+ getAsst_exp_date() + ", getAsst_rmks()=" + getAsst_rmks() + ", getVender_name()=" + getVender_name()
				+ ", getPurchase_details()=" + getPurchase_details() + ", getDepr_flag()=" + getDepr_flag()
				+ ", getDepr_freq()=" + getDepr_freq() + ", getDepr_method()=" + getDepr_method()
				+ ", getDepr_percent()=" + getDepr_percent() + ", getAcc_depr()=" + getAcc_depr()
				+ ", getDate_of_last_depr()=" + getDate_of_last_depr() + ", getDate_of_acqn()=" + getDate_of_acqn()
				+ ", getDate_of_last_tfr()=" + getDate_of_last_tfr() + ", getCur_book_value()=" + getCur_book_value()
				+ ", getMkt_value()=" + getMkt_value() + ", getLoc_type()=" + getLoc_type() + ", getSol_id()="
				+ getSol_id() + ", getEmp_id()=" + getEmp_id() + ", getDept_div_name()=" + getDept_div_name()
				+ ", getLoca_addr()=" + getLoca_addr() + ", getLoc_rmks()=" + getLoc_rmks() + ", getGtee_amt()="
				+ getGtee_amt() + ", getGtee_amt_percent()=" + getGtee_amt_percent() + ", getNom_depr_amt()="
				+ getNom_depr_amt() + ", getDepr_rmks()=" + getDepr_rmks() + ", getEntry_user()=" + getEntry_user()
				+ ", getModify_user()=" + getModify_user() + ", getAuth_user()=" + getAuth_user() + ", getEntry_time()="
				+ getEntry_time() + ", getModify_time()=" + getModify_time() + ", getAuth_time()=" + getAuth_time()
				+ ", getDel_flg()=" + getDel_flg() + ", getEntity_flg()=" + getEntity_flg() + ", getModify_flg()="
				+ getModify_flg() + ", getSale_flg()=" + getSale_flg() + ", getWrite_off_flg()=" + getWrite_off_flg()
				+ ", getVerify_flg()=" + getVerify_flg() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
				+ ", toString()=" + super.toString() + "]";
	}
	public BTM_BAMInventorymaster_Entity(String asst_srl_no, String asst_name, String acc_number, String asset_head,
	...
	public BTM_BAMInventorymaster_Entity() {
		super();
