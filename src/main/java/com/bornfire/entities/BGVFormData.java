...
public class BGVFormData {
	...
	public BGVFormData(String emp_type, String organization, String emp_id, String emp_name, String qual,
			String designation, String role, String address, Date date_of_birth, Date date_of_joining, String bank_name,
			String acct_no, String pan_no, String aadhaar_no, String passport, String driving_license,
			BigDecimal mobile_no, String email, Date date_of_email_intimation, String previous_experience,
			String check_details, Date doc_frm_emp, Date doc_sub_date, String follow_up_action_1, Date remainder_date_1,
			String follow_up_action_2, Date remainder_date_2, String follow_up_action_3, Date remainder_date_3,
			Date doc_send_date, Date date_of_receipt, String doc_status, String remarks, Date invoice_date,
			Date pay_date, BigDecimal invoice_amt, String entry_user, String modify_user, String auth_user,
			Date entry_time, Date modify_time, Date auth_time, String entity_flg, String modify_flg, String del_flg) {
		super();
		this.emp_type = emp_type;
		this.organization = organization;
		this.emp_id = emp_id;
